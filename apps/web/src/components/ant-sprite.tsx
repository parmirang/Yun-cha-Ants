...
const BIG_POSES = {
  ...
  crawl1: [
    ...
    ".....................hhhhhh.....",
    "...ggggg............hhhhhhhh....",
    ".ggggggggg...tttt..hhhhhhhhhh...",
    "ggggGGGggg..tttttt.hhhhhKehheh..",
    "gggGGGGGggttttttttthhhhhKKhhKhh.",
    "gggGGGGGggttttttttthhhhhhhhhhhh.",
    ".gggGGGggg..tttttt.hhhhhhhhhhhhh",
    "..gggggggg...tttt..hhhhhhhhhhhhh",
    "...gggggg...llllll..hhhhhhKKKKh.",
    "....llll....l....l...hhhhhhhhh..",
    "......l.....l....l.....hhhhh....",
    "......l....l......l.............",
    ".....ll....l......l.............",
  ...
  /*
   * ── 여기부터는 기본 자세에서 갈라져 나온 것들 ──
   * 몸통을 좌표까지 물려받고 **팔다리만 다르다.** 팔은 대표에서 먼저 벗기고 32칸 격자에
   * 새로 찍는다 — 16칸 팔을 2배로 늘려 붙이면 잘아진 격자를 쓰는 뜻이 없어진다.
   */

  /*
   * 가로로 뻗은 두 팔. **한 줄 두께로 그리고 사이를 띄운다** — 겹쳐 그리면 한 자루
   * 몽둥이가 되고, 두 줄로 두께를 주면 다리(한 칸)보다 두 배라 팔로 안 읽힌다.
   */
  /*
   * 뛰기 — **뒤쪽(왼쪽) 팔을 곧게 세운다.** 앞팔을 올리면 앞으로 나온 입 옆에 붙어
   * 실루엣이 뭉개지고, 한 칸짜리 대각선으로 올리면 계단처럼 끊겨 팔로 안 읽힌다.
   *
   * **마지막 줄을 비운다** — 발끝이 바닥 줄에 닿아 있으면 아무리 띄워 그려도 서 있는
   * 그림이다. 다리는 몸쪽으로 접어 올린다.
   */
  jump: [
    "..............nn................",
    ".............n....nn............",
  ...
  /*
   * 비스듬히 내려친 두 팔 — 앞팔이 먼저 내려가고 뒷팔이 따라간다. **위로는 안 든다**
   * (앞으로 나온 입 옆에 붙어 실루엣이 뭉갠다).
   */
  dig2: [
    "..............nn................",
    ".............n....nn............",
...
/**
 * **기본 자세 여덟** — 몸이 서로 달라 자동 반영으로 못 만드는 것들이라 사람이 하나씩
 * 다듬는다. 나머지는 여기서 갈라져 나온 파생이라 서랍에서 딸린 동작으로 선다.
 */
export const ANT_BIG_BASIC_POSE_IDS: readonly AntBigPose[] = [
  "stand",
  "crawl1",
  "prone",
  "back1",
