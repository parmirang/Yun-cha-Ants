...
const FACE: readonly string[] = [
  ...
  ".ohhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhho",
  ".ohhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhho",
  "..ohhhhhhhhhhhhhooooooooooooooooooooohhhhhhhhhhhhho.",
  "..ohhhhhhhhooooommmmmmmmmmmmmmmmmmmmmooooohhhhhhhho.",
  "..ohhhhhooommmmmmmmmmmmmmmmmmmmmmmmmmmmmmmooohhhhho.",
  "...ohhoommmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmoohho..",
  "....oommmmmmmmmmmmmMMMMMMMmmmmmmmmmmmmmmMMMMMMMoo...",
  ".....MMMmmmmmmmMMMMmmmmmmmMMMmmmmmmmMMMMmmmmmmmM....",
  "......mmMMMMMMMmmmmmmmmmmmmmmMMMMMMMmmmmmmmmmmm.....",
  ".......ommmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmo......",
  "........ooommmmmmmmmmmmmmmmmmmmmmmmmmmmmmmooo.......",
  "........ohhooooommmmmmmmmmmmmmmmmmmmmooooohho.......",
  ".........ossssssooooooooooooooooooooosssssso........",
